# Generated by Django 4.0.1 on 2022-08-27 16:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('respToUser', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='userResps', to='user.profile')),
        ...
        migrations.AddField(
            model_name='comment',
            name='site',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='all_comments', to='blog.site'),
        ),
